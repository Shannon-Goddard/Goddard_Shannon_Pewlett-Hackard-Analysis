...
<img src="https://github.com/Shannon-Goddard/Goddard_Shannon_Pewlett-Hackard-Analysis/blob/master/EmployeeDB.png" class="callout"/>A conceptual diagram is an ERD in its simplest form. To create one, we only need two things: a table name and column headers.  
